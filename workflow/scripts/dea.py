...
vs=snakemake.params.contrast
lfc_thr = (snakemake.params.logFC,snakemake.params.logFC)
...
is_equal=len(volcano_path)==len(ma_path)==len(vs)==len(dea_path)
...
for a,b,c,d in zip(vs,dea_path,volcano_path,ma_path):
	run_dea(a,b,c,d)